...
def main():
    ...
    xception_model.summary(show_trainable = True)
    # vgg16_model.summary(show_trainable = True, print_fn=myprint)
    myprintFile(xception_model, 'xception_full.txt')
    # vgg16_model.summary(show_trainable = True, print_fn=myprint)
    ...
    plot_model(xception_model, 'Xception_full.png', show_shapes=True, show_dtype=True, show_layer_names=True, rankdir='TB', expand_nested=True, show_layer_activations=True, show_trainable=True)
    ...
    xception_model.summary(show_trainable = True)
    myprintFile(xception_model, 'xception_backbone.txt')
    plot_model(xception_model, 'Xception_backbone.png', show_shapes=True, show_dtype=True, show_layer_names=True, rankdir='TB', expand_nested=True, show_layer_activations=True, show_trainable=True)

...
def main():
    ...
    myprintFile(vgg16_model, 'vgg16_full.txt')
    # vgg16_model.summary(show_trainable = True, print_fn=myprint)
    ...
    vgg16_model.summary(show_trainable = True)
    myprintFile(vgg16_model, 'vgg16_backbone.txt')
    plot_model(vgg16_model, 'VGG16_backbone.png', show_shapes=True, show_dtype=True, show_layer_names=True, rankdir='TB', expand_nested=True, show_layer_activations=True, show_trainable=True)
